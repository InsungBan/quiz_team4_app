      ...
      body: GetBuilder<HealthController>(
        builder: (controller) {
          ...
          return ListView.builder(
            ...
            itemCount: controller.healthList.length,
            itemBuilder: (context, index) {
              final data = controller.healthList[index];

              bool isSelected = controller.selectedIndex == index;

              return GestureDetector(
                onTap: () => controller.selectHealth(index),
                child: Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      IconButton(
                        ...
                        icon: const Icon(Icons.access_time_outlined, color: Colors.cyan, size: 20),
                      ),
                    ],
                  ),
                ),
